  ...
  return (
    <Page isProtected={false} headContent={headContent}>
      <div className="about-container">
        <h1>About Us</h1>
        <p>Welcome to Highpoint Grove's Youth volleyball! After living in this community for over 15 years, and with the growth of our family and our interests, we decided to move forward with maximizing the use of our property.</p>
